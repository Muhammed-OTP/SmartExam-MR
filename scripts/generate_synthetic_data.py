...
def generate_synthetic_data(num_records=150):
    ...
    for i in range(1, num_records + 1):
        ...
        ref_ans = f"This is the reference answer for a {q_type} in {course}." * np.random.randint(1, 4)
        stu_ans = f"This is the student answer regarding {course}." * np.random.randint(1, 4)
