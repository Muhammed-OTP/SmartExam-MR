...
def create_sklearn_pipeline() -> ColumnTransformer:
    ...
    numeric_features = [
        'score', 'question_length', 
        'reference_answer_length', 'student_answer_length', 
        'word_overlap_ratio'
    ]
...
def build_and_save_pipeline(input_path: str, output_data_path: str, output_pipeline_path: str):
